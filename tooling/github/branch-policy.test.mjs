...
test("branch policy accepts only same-repository Dependabot branches", () => {
  assert.equal(evaluateBranchPolicy(pr("dev", "dependabot/github_actions/dev/actions/checkout-7.0.1")).ok, true);
  assert.equal(evaluateBranchPolicy(pr("dev", "dependabot/npm_and_yarn/dev/typescript-6", fork)).ok, false);
});
